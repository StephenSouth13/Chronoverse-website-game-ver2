...
import SuggestionForm from "@/components/contact/SuggestionForm" // Import the new component
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-deep-space text-foreground pt-24 pb-12 px-4 md:px-8 lg:px-16">
      ...
      {/* Suggestions Section */}
      <ScrollAnimationWrapper delay={0.4} className="container mx-auto mt-12">
        <SuggestionForm />
      </ScrollAnimationWrapper>
    </div>
  )
