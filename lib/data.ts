...
export const mockFAQs: FAQItem[] = [
  ...
  {
    question: "ChronoVerse có miễn phí không?",
    question_en: "Is ChronoVerse free to play?",
    answer: "ChronoVerse hoàn toàn miễn phí để chơi trên trình duyệt web.",
    answer_en: "ChronoVerse is completely free to play directly in your web browser.",
  },
  {
    question: "Tôi có thể đóng góp ý kiến cho game không?",
    question_en: "Can I provide feedback for the game?",
    answer:
      "Chắc chắn rồi! Chúng tôi luôn hoan nghênh mọi ý kiến đóng góp từ cộng đồng. Bạn có thể gửi góp ý qua form liên hệ trên trang 'Liên Hệ' hoặc tham gia Discord của chúng tôi.",
    answer_en:
      "We always welcome feedback from the community. You can submit your suggestions via the contact form on the 'Contact' page or join our Discord server.",
  },
  {
    question: "Game có yêu cầu cấu hình máy cao không?",
    question_en: "Does the game require high system specifications?",
    answer:
      "ChronoVerse được tối ưu hóa để chạy mượt mà trên hầu hết các máy tính hiện đại có hỗ trợ WebGL 2.0. Bạn có thể xem chi tiết yêu cầu hệ thống trên trang 'Chơi Game'.",
    answer_en:
      "ChronoVerse is optimized to run smoothly on most modern computers with WebGL 2.0 support. You can find detailed system requirements on the 'Play Game' page.",
  },
]
